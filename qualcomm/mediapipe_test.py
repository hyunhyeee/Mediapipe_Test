...
# ) as hands:
#     print("카메라 실행 중... 영어로 입력하고 엔터를 누르세요.")
...
# # Mediapipe 모델을 TensorFlow Lite로 변경
# model_path = 'hand_landmarker.task'  # hand_landmarker TensorFlow Lite 모델 파일 경로
# hand_landmarker = vision.HandLandmarker.create_from_model_path(model_path)
...
#     mp_image = Image.create_from_array(frame_rgb)

#     # 손 랜드마크 예측
#     results = hand_landmarker.detect(mp_image)  # 이제 Image 객체를 전달
...
#     # 이미지 형식을 mediapipe.Image로 변환하고, 형식 지정
